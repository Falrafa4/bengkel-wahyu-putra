...
<aside>
    ...
    <div class="nav-dash">
        ...
        <a href="/bengkel-wahyu-putra/dashboard/admin/services" class="<?= ($namaFolder == "services" || $namaFolder2 == "services") ? 'active' : '' ?>"><i class="fas fa-screwdriver-wrench"></i>Layanan</a>
        <a href="/bengkel-wahyu-putra/dashboard/admin/pelanggan/" class="<?= ($namaFolder == "pelanggan" || $namaFolder2 == "pelanggan") ? 'active' : '' ?>"><i class="fas fa-users"></i>Pelanggan</a>
        <a href="/bengkel-wahyu-putra/dashboard/admin/pemesanan/" class="<?= ($namaFolder == "pemesanan" || $namaFolder2 == "pemesanan") ? 'active' : '' ?>"><i class="fas fa-bag-shopping"></i>Pemesanan</a>
